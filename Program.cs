...
using System.Text;
using desafio_dotnet.Dominio.DTOs.ModelViews;
using desafio_dotnet.Dominio.Enuns;
using desafio_dotnet.Dominio.ModelViews;
using DesafioDotnet.Dominio.Entidades;
using DesafioDotnet.Dominio.interfaces;
using DesafioDotnet.Dominio.Servicos;
...
builder.Services.AddDbContext<DesafioDotnet.Infraestrutura.Db.DbContexto>(options =>
{
...
app.MapGet("/administradores/login", ([FromQuery] int? pagina, IAdministradorServico administradorServico) =>
{
...
app.MapPut("/veiculo/{id}", ([FromQuery]int id, VeiculoDTO veiculoDTO , IVeiculoServico veiculoServico ) =>
{
        var veiculo = veiculoServico.BuscaPorId(id);
    if (veiculo == null) return Results.NotFound();
...
app.MapDelete("/veiculo/{id}", ([FromQuery]int id,IVeiculoServico veiculoServico ) =>
{
    var veiculo = veiculoServico.BuscaPorId(id);
